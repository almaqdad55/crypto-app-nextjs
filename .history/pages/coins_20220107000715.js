...
const coins = ({ coinsData }) => {
  ...
  return (
    <>
      ...
      />
      <div className="container flex justify-center mx-auto mt-10 h-screen overflow-y-hidden">
                ...
                <tbody className="bg-white divide-y divide-gray-300  cursor-pointer ">
                  {filteredData.map(
                    ({
                      ...
                      <tr
                        key={id}
                        className="whitespace-nowrap odd:bg-white even:bg-slate-200  even:hover:bg-slate-400  odd:hover:bg-gray-100"
                      >
