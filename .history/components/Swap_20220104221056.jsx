...
const Swap = () => {
  return (
    <div className=" flex text-[#2A316F] justify-between">
      <div className="relative flex bg-red-300 py-5">
        <img src="/bitcoin-icon.svg" alt="" className="h-50 absolute " />
        <img src="/ripple-icon.svg" alt="" className="h-50 top-0 right-0" />
      </div>
      <div className="py-5">
